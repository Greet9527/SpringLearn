...
public class SimpleAspect {
    ...
    private final String POINT_CUT="execution(public * org.grit.aspects.services.SimpleDemoService.*(..))";
    @Pointcut(POINT_CUT)
    ...
    public void doAfterThrowing(JoinPoint joinPoint,Throwable exception){
        System.out.println("@afterThrowing：切点方法抛异常执行..... exception:"+exception.getMessage());
    }
